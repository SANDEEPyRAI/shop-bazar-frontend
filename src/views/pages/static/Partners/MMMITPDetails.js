      ...
      <Container>
        <div className={classes.campusimgbox}>
          <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
            <Box className={classes.bannerbox}>
              <img
                src="images/ResourcesImg/Marathwada Mitra Mandals Institute of Technology, Pune.jpg"
                alt="iitmadraash"
            ...
            <div className={classes.logo}>
              <Box className={classes.logobox}>
                <img
                  src="images/ResourcesImg/Marathwada.png"
                  alt="Marathwadalogo"
          ...
          <div>
            <div className={classes.heading}>
              <Typography className={classes.headingtext}>
                Marathwada Mitra Mandals Institute of Technology, Pune
              </Typography>
              <Typography style={{ paddingTop: "10px" }}>
                {" "}
                <b>Address: </b>{" "}
                <span style={{ color: "#636880" }}>
                  Wadgaon Shinde Road, Lohegaon, Pune, Maharashtra 411047
                </span>
              </Typography>
        ...
        <Grid container spacing={6}>
          <Grid item xs={12} sm={12} md={6}>
            <img
              src="images/ResourcesImg/MMMIT.jpeg"
              alt="iitmadraash"
          ...
          <Grid item xs={12} sm={12} md={6}>
            <Typography variant="h6" style={{ color: "#262626" }}>
              <b>
                I&AI CoE at Marathwada Mitra Mandals Institute of Technology,
                Pune
              </b>
            </Typography>
            <Typography className={classes.paragraph}>
              ...
              CoE) in collaboration with Marathwada Mitra Mandals Institute of
              Technology, Pune. The memorandum of understanding (MoU) was signed
            ...
            <Grid item xs={12} sm={12} md={12}>
              ...
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3781.1551927262867!2d73.9380616744939!3d18.61208816637372!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c426abe950f1%3A0xabecafd9c9680bd1!2sMarathwada%20Mitra%20Mandal&#39;s%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1707908407841!5m2!1sen!2sin"
                  width="100%"
                  frameborder="0"
                  style={{ height: "100%", width: "100%", objectFit: "cover" }}
                ></iframe>
