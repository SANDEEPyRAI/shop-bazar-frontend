        ...
        <Container>
          <div className={classes.campusimgbox}>
            <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
              <Box className={classes.bannerbox}>
                <img
                  src="images/ResourcesImg/Maulana Azad University, Jodhpur.jpg"
                  alt="iitmadraash"
              ...
              <div className={classes.logo}>
                <Box className={classes.logobox}>
                  <img
                    src="images/ResourcesImg/Maulana.png"
                    alt="iitmadraashlogo"
              ...
              <div className={classes.heading}>
                ...
                <Typography style={{ paddingTop: "10px" }}>
                  ...
                  <span style={{ color: "#636880" }}>
                    Village Bujhawar, Tehsil Luni, Jodhpur, Rajasthan 342802
                  </span>
                </Typography>
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} sm={12} md={6}>
              <img
                src="images/ResourcesImg/Maulanacollege.jpg"
                alt="iitmadraash"
            ...
            <Grid item xs={12} sm={12} md={6}>
              <Typography variant="h6" style={{ color: "#262626" }}>
                <b>I&AI CoE at Maulana Azad University, Jodhpur.</b>
              </Typography>
              <Typography className={classes.paragraph}>
                ...
                CoE) in collaboration with Maulana Azad University, Jodhpur .
                ...
                our commitment to fostering innovation and technology adoption
                in education. The CoE was inaugurated on [Date of Inauguration]
                by [Name of Key Management Personnel of the Institute], marking
                a significant milestone in our partnership journey.
              </Typography>
              <Typography className={classes.paragraph}>
              ...
              <Grid item xs={12} sm={12} md={12}>
                ...
                >
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57265.37843479251!2d72.83912342167969!3d26.226390099999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39418e8481a5e347%3A0x371ff4504b4488ff!2sMaulana%20Azad%20University%20Jodhpur!5e0!3m2!1sen!2sin!4v1707908224644!5m2!1sen!2sin"
                    width="100%"
                    frameborder="0"
                    style={{
                      height: "100%",
