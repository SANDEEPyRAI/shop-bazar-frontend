        ...
        <Container>
          <div className={classes.campusimgbox}>
            <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
              <Box className={classes.bannerbox}>
                <img
                  src="images/ResourcesImg/Poornima University, Jaipur.jpg"
                  alt="iitmadraash"
              ...
              <div className={classes.logo}>
                <Box className={classes.logobox}>
                  <img
                    src="images/ResourcesImg/Poornima.png"
                    alt="Poornimalogo"
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} sm={12} md={6}>
              <img
                src="images/ResourcesImg/Poornimacollege.jpg"
                alt="iitmadraash"
            ...
            <Grid item xs={12} sm={12} md={6}>
              <Typography variant="h6" style={{ color: "#262626" }}>
                <b>I&AI CoE at Poornima University, Jaipur</b>
              </Typography>
              <Typography className={classes.paragraph}>
                ...
                CoE) in collaboration with Poornima University, Jaipur. The
              ...
              <Grid item xs={12} sm={12} md={12}>
                ...
                >
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3561.8946793276623!2d75.87444327473933!3d26.77962696579847!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396dc9d5c3d68749%3A0xa227c3f0db21d4fc!2sPoornima%20University!5e0!3m2!1sen!2sin!4v1707909217723!5m2!1sen!2sin"
                    width="100%"
                    frameborder="0"
                    style={{
                      height: "100%",
