...
function App() {
  ...
  const testimonials = [
    {
      image: "./images/collegegallery/RIT1.jpg",
    },
    {
      image: "./images/collegegallery/RIT2.jpg",
    },
    {
      image: "./images/collegegallery/RIT3.jpg",
    },
    {
      image: "./images/collegegallery/RIT4.jpg",
    },
    {
      image: "./images/collegegallery/RIT5.jpg",
    },
    {
      image: "./images/collegegallery/RIT6.jpg",
    },
  ];
  return (
    <>
        ...
        <Container>
          <div className={classes.campusimgbox}>
            <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
              <Box className={classes.bannerbox}>
                <img
                  src="images/ResourcesImg/Roorkee Institute of Technology, Roorkee.jpg"
                  alt="iitmadraash"
              ...
              <div className={classes.logo}>
                <Box className={classes.logobox}>
                  <img
                    src="images/ResourcesImg/Roorkee.png"
                    alt="Roorkeelogo"
              ...
              <div className={classes.heading}>
                ...
                <Typography style={{ paddingTop: "10px" }}>
                  ...
                  <span style={{ color: "#636880" }}>
                    Puhana - Jhabrera Rd, Nanheda Anantpur, Uttarakhand 247668
                  </span>
                </Typography>
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} sm={12} md={6}>
              <img
                src="images/ResourcesImg/ritroorkeecollege.jpeg"
                alt="iitmadraash"
            ...
            <Grid item xs={12} sm={12} md={6}>
              <Typography variant="h6" style={{ color: "#262626" }}>
                <b>I&AI CoE at Roorkee Institute of Technology, Roorkee</b>
              </Typography>
              <Typography className={classes.paragraph}>
                ...
                CoE) in collaboration with Roorkee Institute of Technology,
                Roorkee. The memorandum of understanding (MoU) was signed on
                18th January 2024 by Prof. Dr. P. P. Dhyani Director RIT and Mr.
                Akash Gehlot, Director Skills & Corporate Relations Mobiloitte,
                solidifying our commitment to fostering innovation and
                technology adoption in educion, marking a significant milestone
                in our partnership journey.
              </Typography>
              <Typography className={classes.paragraph}>
                Since its inception, the CoE has been instrumental under the
                guidance of Mr. Pragyesh Chaudhary, aimed at empowering students
                and faculty with cutting-edge skills in artificial intelligence,
              ...
              <Grid item xs={12} sm={12} md={12}>
                ...
                >
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3458.5602181675094!2d77.83490067485836!3d29.90577012512899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390eb3872d4ee97f%3A0x95ad9a09ddc53e3f!2sRoorkee%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1707910737021!5m2!1sen!2sin"
                    width="100%"
                    frameborder="0"
                    style={{
                      height: "100%",
