...
function App() {
  ...
  const testimonials = [
    {
      image: "./images/collegegallery/Tullas1.jpg",
    },
    {
      image: "./images/collegegallery/Tullas2.jpg",
    },
    {
      image: "./images/collegegallery/Tullas3.jpg",
    },
    {
      image: "./images/collegegallery/Tullas2.jpg",
    },
        ...
        <Container>
          <div className={classes.campusimgbox}>
            <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
              <Box className={classes.bannerbox}>
                <img
                  src="images/ResourcesImg/Tula’s Institute.jpg"
                  alt="iitmadraash"
              ...
              <div className={classes.logo}>
                <Box className={classes.logobox}>
                  <img
                    src="images/ResourcesImg/tulas.png"
                    alt="tulaslogo"
              ...
              <div className={classes.heading}>
                ...
                <Typography style={{ paddingTop: "10px" }}>
                  ...
                  <span style={{ color: "#636880" }}>
                    ...
                    Uttarakhand Uttarakhand, 248197
                  </span>
                </Typography>
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} sm={12} md={6}>
              <img
                src="images/ResourcesImg/tula'scollege.jpeg"
                alt="iitmadraash"
            ...
            <Grid item xs={12} sm={12} md={6}>
              <Typography variant="h6" style={{ color: "#262626" }}>
                <b>I&AI CoE at Tula’s Institute</b>
              </Typography>
              <Typography className={classes.paragraph}>
                ...
                CoE) in collaboration with Tula’s Institute. The memorandum of
              ...
              <Grid item xs={12} sm={12} md={12}>
                ...
                >
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3443.2768603218406!2d77.8834159748761!3d30.343080604360953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390929fa74538275%3A0x3cb757428c691de3!2sTula&#39;s%20Institute!5e0!3m2!1sen!2sin!4v1707917242062!5m2!1sen!2sin"
                    width="100%"
                    frameborder="0"
                    style={{
                      height: "100%",
