...
function App() {
  ...
  const testimonials = [
    {
      image: "./images/collegegallery/SVPM4.jpeg",
    },
    {
      image: "./images/collegegallery/SVPM2.jpg",
    },
    {
      image: "./images/collegegallery/SVPM3.jpg",
    },
    {
      image: "./images/collegegallery/SVPM1.jpg",
    },
  ];
  return (
    <>
      ...
      <Container>
        <div className={classes.campusimgbox}>
          <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
            <Box className={classes.bannerbox}>
              <img
                src="images/ResourcesImg/Shivnagar Vidya Prasarak Mandal, Pune.jpg"
                alt="iitmadraash"
            ...
            <div className={classes.logo}>
              <Box className={classes.logobox}>
                <img
                  src="images/ResourcesImg/Shivnagar.png"
                  alt="iitmadraashlogo"
          ...
          <div>
            <div className={classes.heading}>
              <Typography className={classes.headingtext}>
                Shivnagar Vidya Prasarak Mandal, Pune
              </Typography>
              <Typography style={{ paddingTop: "10px" }}>
                {" "}
                <b>Address: </b>{" "}
                <span style={{ color: "#636880" }}>
                  Nira-Baramati Road, Malegaon Budruk, Malegaon Bk, Maharashtra
                  413115
                </span>
              </Typography>
        ...
        <Grid container spacing={6}>
          <Grid item xs={12} sm={12} md={6}>
            <img
              src="images/ResourcesImg/shivnagarcollege.jpg"
              alt="iitmadraash"
          ...
          <Grid item xs={12} sm={12} md={6}>
            <Typography variant="h6" style={{ color: "#262626" }}>
              <b>I&AI CoE at Shivnagar Vidya Prasarak Mandal, Pune</b>
            </Typography>
            <Typography className={classes.paragraph}>
              ...
              CoE) in collaboration with Shivnagar Vidya Prasarak Mandal, Pune.
            ...
            <Grid item xs={12} sm={12} md={12}>
              ...
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3791.575868103416!2d74.4963343744826!3d18.13736718076874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc3a73339a0af25%3A0x2da44b11c53f7dec!2sShivnagar%20Vidya%20Prasak%20Mandal!5e0!3m2!1sen!2sin!4v1707915506256!5m2!1sen!2sin"
                  width="100%"
                  frameborder="0"
                  style={{ height: "100%", width: "100%", objectFit: "cover" }}
                ></iframe>
