...
function App() {
  ...
  const testimonials = [
    {
      image: "./images/collegegallery/RSMT1.jpg",
    },
    {
      image: "./images/collegegallery/RSMT2.jpg",
    },
    {
      image: "./images/collegegallery/RSMT6.jpg",
    },
    {
      image: "./images/collegegallery/RSMT4.jpg",
    },
    {
      image: "./images/collegegallery/RSMT8.jpg",
    },
    {
      image: "./images/collegegallery/RSMT6.jpg",
    },
    {
      image: "./images/collegegallery/RSMT7.jpg",
    },
    {
      image: "./images/collegegallery/RSMT3.jpg",
    },
    {
      image: "./images/collegegallery/RSMT9.jpg",
    },
    {
      image: "./images/collegegallery/RSMT10.jpg",
    },
  ];
      ...
      <Container>
        <div className={classes.campusimgbox}>
          <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
            <Box className={classes.bannerbox}>
              <img
                src="images/ResourcesImg/RAJARSHI SCHOOL OF MANAGEMENT & TECHNOLOGY, VARANASI.jpg"
                alt="Rajarshi"
            ...
            <div className={classes.logo}>
              <Box className={classes.logobox}>
                <img
                  src="images/ResourcesImg/Rajarshi.jpg"
                  alt="Rajarshilogo"
            ...
            <div className={classes.heading}>
              ...
              <Typography style={{ paddingTop: "10px" }}>
                ...
                <span style={{ color: "#636880" }}>
                  Narayanpur, Varanasi, Uttar Pradesh 221003
                </span>
              </Typography>
        ...
        <Grid container spacing={6}>
          <Grid item xs={12} sm={12} md={6}>
            <img
              src="images/ResourcesImg/rajarshricollege.jpg"
              alt="iitmadraash"
          ...
          <Grid item xs={12} sm={12} md={6}>
            <Typography variant="h6" style={{ color: "#262626" }}>
              <b>
                I&AI CoE at RAJARSHI SCHOOL OF MANAGEMENT & TECHNOLOGY, VARANASI
              </b>
            </Typography>
            <Typography className={classes.paragraph}>
              ...
              CoE) in collaboration with Rajarshi School of Management and
              Technology, Varanasi. The memorandum of understanding (MoU) was
              signed on Nov.11, 2022 by Dr. Aman Gupta - Director RSMT and Mr.
              Aakash Gehlot - Director Skills & Corporate Relations Mobiloitte,
              solidifying our commitment to fostering innovation and technology
              adoption in education. The CoE was inaugurated on Feb.18, 2023 by
              Dr. Aman Gupta - Director RSMT and Mr. Aakash Gehlot - Director
              Skills & Corporate Relations Mobiloitte, and Mr. Gaurav Khaturia -
              Branding & Strategy Vice President Moiloitte, marking a
              significant milestone in our partnership journey.
            </Typography>
            <Typography className={classes.paragraph}>
              Since its inception, the CoE has been instrumental under the
              guidance of Dr. Aman Gupta, aimed at empowering students and
            ...
            <Grid item xs={12} sm={12} md={12}>
              ...
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3605.444996869593!2d82.9693807746897!3d25.356398425235326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398e2c4a7c7fc5d7%3A0x2740d1af6c1197a7!2sRSMT%20Up%20College%20Campus!5e0!3m2!1sen!2sin!4v1707909725241!5m2!1sen!2sin"
                  width="100%"
                  frameborder="0"
                  style={{ height: "100%", width: "100%", objectFit: "cover" }}
                ></iframe>
