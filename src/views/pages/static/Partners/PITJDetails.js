...
function App() {
  ...
  const testimonials = [
    {
      image: "./images/collegegallery/PIT1.jpeg",
    },
    {
      image:"./images/collegegallery/PIT2.jpeg",
    },
    {
      image:"./images/collegegallery/PIT1.jpeg",
    },
    {
      image:"./images/collegegallery/PIT3.jpeg",
    },
  ];
  return (
    <>
      ...
      <Container>
        <div className={classes.campusimgbox}>
          <div style={{ maxWidth: "1282px", maxHeight: "361px" }}>
            <Box className={classes.bannerbox}>
              <img
                src="images/ResourcesImg/Prasad Institute of Technology, Jaunpur.jpg"
                alt="iitmadraash"
            ...
            <div className={classes.logo}>
              <Box className={classes.logobox}>
                <img
                  src="images/ResourcesImg/Prasad.png"
                  alt="iitmadraashlogo"
            ...
            <div className={classes.heading}>
              ...
              <Typography style={{ paddingTop: "10px" }}>
                ...
                <span style={{ color: "#636880" }}>
                  Jaunpur, Balibhaddarpur, Uttar Pradesh 222002
                </span>
              </Typography>
        ...
        <Grid container spacing={6}>
          <Grid item xs={12} sm={12} md={6}>
            <img
              src="./images/collegegallery/PITSign.jpeg"
              alt="iitmadraash"
          ...
          <Grid item xs={12} sm={12} md={6}>
            <Typography variant="h6" style={{ color: "#262626" }}>
              <b>I&AI CoE at Prasad Institute of Technology, Jaunpur</b>
            </Typography>
            <Typography className={classes.paragraph}>
              ...
              CoE) in collaboration with Prasad Institute of Technology,
              Jaunpur. The memorandum of understanding (MoU) was signed on 30th
              January 2024 by Dr. Srinivasa Rao Balasani Principal and Mr. Akash
              Gahlot, solidifying our commitment to fostering innovation and
              technology adoption in education, marking a significant milestone
              in our partnership journey.
            </Typography>
            <Typography className={classes.paragraph}>
              Since its inception, the CoE has been instrumental under the
              guidance of Mr. Chandra Ketu Singh, aimed at empowering students
